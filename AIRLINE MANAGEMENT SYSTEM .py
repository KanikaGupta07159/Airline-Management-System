...
def menu():
    ...
    while c=='y':
        print("\t\t---------------------------------------------------------------------")
        print("\t\t**********WELCOME TO AIRLINE RESERVATION & MANAGEMENT SYSTEM*********")
        print("\t\t---------------------------------------------------------------------")
        print("\n\t\t#######BY KANIKA & ANUSHREE########")
        print("---------------------------------------------------------------------")
        print("                                  ^              ")
...
try:
    ...
    print("IF U WANT TO OPEN THIS PROJECT PLEASE ENTER APPROPRIATE OPTION")
    exit()
...
def updatename():
    ...
    try:
        ...
        f_name=input("enter updated flight name:")
...
def updatecls_cd():
    ...
    try:
        ...
        cur=db.cursor()
        f_code=int(input("enter the flight code where u want to update that record:"))
        class_code=input("enter updated class code:")
...
def updatenationality():
    ...
    try:
        ...
        cur=db.cursor()
        PNRno=int(input("enter the PNRno where u want to update that record:"))
        nationality=input("enter updated nationality(FIRST LETTER IN CAPS):")
        if nationality in nation:
...
def show_journey_details():
    ...
    try:
        db=con.connect(host="localhost",user=user,passwd=password,database="airlinemgn")
        cur=db.cursor()
        cur.execute("select PNRno,ticket_id,f_code,date_format(JNY_date,'%d-%m-%Y') as jny_date,date_format(arrtime,'%h-%i-%p') arrtime, date_format(deptime,'%h-%i-%p') deptime,source,destination from journey")
        rec=cur.fetchall()
        for x in rec:
            print(x)
    except:
...
def updatef_code():
    ...
    try:
        ...
        f_code=int(input("enter the updated FLIGHT CODE:"))
...
def updateticket_id():
    ...
    try:
        ...
        ticket_id=input("enter the updated TICKET ID")
